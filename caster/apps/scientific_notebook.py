...
class SNRule(MergeRule):
    ...
    mapping = {
        ...
        "begin [bulleted] list": Key("a-1, down:2, enter"),
        "begin numbered list": Key("a-1, down:4, enter"),
        "end [(bulleted | numbered)] list": Key("a-1, up, enter"),

        "insert normal text": Key("a-3, down, enter"),
        "insert big text": Key("a-3, down:2, enter"),
...
context = AppContext(executable="scientific notebook") | AppContext(executable="snb")
